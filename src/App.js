      ...
      <>
        ...
        <div class="header">
          <div class="col-12 row">
            <div class="col-md-8 checkHeaderRight">
              ...
              <div class="space"></div>
              <i class="bi bi-list iconAdd iconMenu" onClick={() => this.setBar(true)}></i>
            ...
            <div class="col-md-4 checkHeaderLeft">
