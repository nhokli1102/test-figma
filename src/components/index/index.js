...
class index extends Component {
    ...
    render() {
        const {  showModal, showModalStepper, showModalBids} = this.state;
        return (
            <>
                {/* canvas */}
                                ...
                                <div class="col-12" >
                                    <table>
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="buttonBack" onClick={this.goBack}>
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td class="">
                                                <div className="d-flex flex-column tdHeader">
                                                    <div className="mx-2">
                                                        ...
                                                        {/* 
                                                        <svg width="33" height="32" viewBox="0 0 33 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M4.25 9.33366C4.25 2.66699 9.58333 2.66699 9.58333 2.66699V16.0003H4.25C4.25 16.0003 4.25 16.0003 4.25 9.33366Z" fill="white" stroke="black" stroke-width="2" stroke-linejoin="round" />
                                                            <path d="M28.2507 6.66699H9.58398V10.667H28.2507V6.66699Z" fill="white" stroke="black" stroke-width="2" stroke-linejoin="round" />
                                                            <path d="M4.25 20H28.25C28.25 20 28.25 25.3333 24.25 25.3333C20.25 25.3333 19.5833 25.3333 19.5833 25.3333L20.9167 29.3333H8.91667L10.25 25.3333H4.25V20Z" fill="#E0E0E0" stroke="black" stroke-width="2" stroke-linejoin="round" />
                                                        </svg> */}
                                            ...
                                            <td>
                                                ...
                                                {/* <svg width="33" height="32" viewBox="0 0 33 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <g clip-path="url(#clip0_771_37565)">
                                                        <path d="M32.5 0H0.5V32H32.5V0Z" fill="white" fill-opacity="0.01" />
                                                        <path d="M26.5 4H6.5C5.39543 4 4.5 4.89543 4.5 6V26C4.5 27.1046 5.39543 28 6.5 28H26.5C27.6046 28 28.5 27.1046 28.5 26V6C28.5 4.89543 27.6046 4 26.5 4Z" fill="#E0E0E0" stroke="black" stroke-width="2" stroke-linejoin="round" />
                                                        <path d="M23.1673 18H9.83398" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                                        <path d="M18.5007 22.667H9.83398" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                                    </g>
                                                    <defs>
                                                        <clipPath id="clip0_771_37565">
                                            ...
                                            <td class="">
                                                <div className="d-flex flex-column tdHeader">
                                                    <div className="mx-2">
                                                        ...
                                                        {/* <svg width="33" height="32" viewBox="0 0 33 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M26.0839 28.0002L28.3444 21.7836C28.5759 21.1472 28.2934 20.4383 27.6877 20.1354L17.3468 14.965C16.9715 14.7773 16.5296 14.7773 16.1543 14.965L5.81345 20.1354C5.20769 20.4383 4.92523 21.1472 5.15667 21.7836L7.41723 28.0002" stroke="black" stroke-width="2" stroke-linejoin="round" />
                                                            <path d="M24.084 9.33301H9.41732C8.68092 9.33301 8.08398 9.92994 8.08398 10.6663V18.6663L16.1919 14.9242C16.5465 14.7606 16.9549 14.7606 17.3094 14.9242L25.4173 18.6663V10.6663C25.4173 9.92994 24.8204 9.33301 24.084 9.33301Z" fill="#E0E0E0" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                                            <path d="M20.0827 9.33366V4.00033C20.0827 3.26395 19.4857 2.66699 18.7493 2.66699H14.7493C14.0129 2.66699 13.416 3.26395 13.416 4.00033V9.33366" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                                            <path d="M16.75 21.333V26.6663" stroke="black" stroke-width="2" stroke-linecap="round" />
                                                            <path d="M3.41602 29.3333C6.08268 29.3333 6.08268 28 8.08268 28C10.0827 28 10.0827 29.3333 12.0827 29.3333C14.0827 29.3333 14.416 28 16.7493 28C19.0827 28 19.416 29.3333 21.416 29.3333C23.416 29.3333 23.416 28 25.416 28C27.416 28 27.416 29.3333 30.0827 29.3333" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                                        </svg> */}
                                            ...
                                            <td>
                                                ...
                                                {/* <svg width="36" height="38" viewBox="0 0 36 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M18 6.75L7.5 13.75L18 20.75L28.5 13.75L18 6.75Z" fill="#E0E0E0" stroke="black" stroke-width="2" stroke-linejoin="round" />
                                            ...
                                            <div class="orderItem">
                                                ...
                                                <table>
                                                    <tbody>
                                                        <tr>
                                                            <td rowspan="6">
                                                                <img class="imgOrder1" src="https://otusstudio.com/wp-content/uploads/2018/09/chup-anh-san-pham-nuoc-hoa-otus-studio-9-300x300.jpg" />
                                                            </td>
                                                            <td class="textItemOrder2">Name:</td>
                                                            <td class="textItemOrder4">WORKPRO 5-Shelf Garage Freestanding Shelves</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="textItemOrder2">Variant:</td>
                                                            <td class="textItemOrder2">Black</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="textItemOrder2">SKU:</td>
                                                            <td class="textItemOrder2">443442299 </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="textItemOrder2">Quantity:</td>
                                                            <td class="textItemOrder2">2</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="textItemOrder2">Bid Price:</td>
                                                            <td class="textItemOrder2">$129</td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <p class="textItemOrderTrackingNumber">
                                                                    Tracking Numbers:
                                                                </p>
                                                            </td>
                                                            <td class="colorHrefTKN2">
                                                                <p>
                                                                    523079971462 - FedEx <br />
                                                                    288343235597 - FedEx
                                                                </p>
                                                            </td>
                                                        </tr>
                ...
                >
                    <Modal.Header closeButton>
                        <Modal.Title id="contained-modal-title-vcenter">
                            <h6 class="textItemOrderTracking">Add Tracking Number</h6>
                        </Modal.Title>
                    </Modal.Header>
                    <Modal.Body>
                        <Form.Group className="mb-3" controlId="formBasicPassword">
                            <Form.Label><h6 className="">Carrier</h6></Form.Label><br/>
                            <select class="selectInModal" aria-label="Default select example">
                                <option class="textInModal" value="1">Carrier</option>
                                <option class="textInModal" value="2">Two</option>
                                <option class="textInModal" value="3">Three</option>
                            </select>
                        </Form.Group>
                        <Form.Group className="mb-3" controlId="formBasicPassword">
                            <Form.Label><h6 className="">Tracking Number</h6></Form.Label>
                            <input class="inputInModal" type="text" placeholder="Enter Tracking Number...." />
                            {/* <Form.Text className="text-muted">
                </Form.Text> */}
                        </Form.Group>
                        <Form.Group className="mb-3" controlId="formBasicPassword">
                            <Form.Label><h6 className="">Quantity</h6></Form.Label>
                            <input class="inputInModal" type="text" placeholder="Enter Quantity...." />
                            {/* <Form.Text className="text-muted">
                </Form.Text> */}
                        </Form.Group>
                    </Modal.Body>
