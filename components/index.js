...
class index extends Component {
  ...
  render() {
    const { steps, showModal, showModalStepper, showModalBids } = this.state;
    return (
      <>
        <div class="header">
          <div class="col-md-12 row">
            <div class="col-md-8 col-xs-12 checkHeaderRight">
            ...
            <div class="col-md-4 col-xs-12 checkHeaderLeft">
              {/* <div class="checkHeader"> */}
              <button type="button" class="buttonTop">
                <div class="textItemOrder" ><i class="bi bi-person-plus iconAdd"></i>Invite Supplier</div>
              </button>
        ...
        <div class="container">
          <div class="row g-2 col-10 offset-1">
            <div class="col-12">
                  ...
                  <table>
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <div class="textBack">
                            <b class="textBackTop">#2262108-PGL</b><i class="bi bi-stickies coppiedIcon"></i><br />
                            <text class="textBackBottom">Jan 15, 2021 at 08:10 pm</text>
                          </div>
                        </td>
                        <td>
                          <div class="textBack">
                      ...
                      <tr>
                        ...
                        <td>
                          <div className="d-flex flex-column">
                            <div className="mx-2">
                              <b class="textTop">Order Placed</b><svg width="14" height="14" class="checkIcon" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <td>
                          <div className="d-flex flex-column">
                            <div className="mx-2">
                              <b class="textTop">Bids</b><svg width="14" height="14" class="checkIcon" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M6.99967 13.6673C10.6816 13.6673 13.6663 10.6825 13.6663 7.00065C13.6663 5.97112 13.433 4.9961 13.0162 4.12559C12.876 3.83259 12.491 3.78552 12.2613 4.01522L7.27582 9.00065C6.75512 9.52135 5.9109 9.52135 5.3902 9.00065L3.52827 7.13872C3.26792 6.87837 3.26792 6.45626 3.52827 6.19591C3.78862 5.93556 4.21073 5.93556 4.47108 6.19591L6.33301 8.05784L11.5675 2.82708C11.7571 2.63755 11.7648 2.33059 11.5696 2.14676C10.3763 1.02278 8.7684 0.333984 6.99967 0.333984C3.31778 0.333984 0.333008 3.31875 0.333008 7.00065C0.333008 10.6825 3.31778 13.6673 6.99967 13.6673Z" fill="#007B5C" />
                              </svg>
                            </div>
                        ...
                        <td>
                          <div className="d-flex flex-column">
                            <div className="mx-2">
                              <b class="textTop">Add TKN (4/4)</b><svg width="14" height="14" class="checkIcon" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M6.99967 13.6673C10.6816 13.6673 13.6663 10.6825 13.6663 7.00065C13.6663 5.97112 13.433 4.9961 13.0162 4.12559C12.876 3.83259 12.491 3.78552 12.2613 4.01522L7.27582 9.00065C6.75512 9.52135 5.9109 9.52135 5.3902 9.00065L3.52827 7.13872C3.26792 6.87837 3.26792 6.45626 3.52827 6.19591C3.78862 5.93556 4.21073 5.93556 4.47108 6.19591L6.33301 8.05784L11.5675 2.82708C11.7571 2.63755 11.7648 2.33059 11.5696 2.14676C10.3763 1.02278 8.7684 0.333984 6.99967 0.333984C3.31778 0.333984 0.333008 3.31875 0.333008 7.00065C0.333008 10.6825 3.31778 13.6673 6.99967 13.6673Z" fill="#007B5C" />
                              </svg>
                            </div>
                        ...
                        <td>
                          <div className="d-flex flex-column">
                            <div className="mx-2">
                              <b class="textTop">Shipped</b><svg width="14" height="14" class="checkIcon" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M6.99967 13.6673C10.6816 13.6673 13.6663 10.6825 13.6663 7.00065C13.6663 5.97112 13.433 4.9961 13.0162 4.12559C12.876 3.83259 12.491 3.78552 12.2613 4.01522L7.27582 9.00065C6.75512 9.52135 5.9109 9.52135 5.3902 9.00065L3.52827 7.13872C3.26792 6.87837 3.26792 6.45626 3.52827 6.19591C3.78862 5.93556 4.21073 5.93556 4.47108 6.19591L6.33301 8.05784L11.5675 2.82708C11.7571 2.63755 11.7648 2.33059 11.5696 2.14676C10.3763 1.02278 8.7684 0.333984 6.99967 0.333984C3.31778 0.333984 0.333008 3.31875 0.333008 7.00065C0.333008 10.6825 3.31778 13.6673 6.99967 13.6673Z" fill="#007B5C" />
                              </svg>
                            </div>
                            <span className="texTopBot">Jan 9, 2022</span>
                        ...
                        <td>
                          <div className="d-flex flex-column">
                            <div className="mx-2">
                              <b class="textTop">Delivered</b><svg width="14" height="14" class="checkIcon" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M6.99967 13.6673C10.6816 13.6673 13.6663 10.6825 13.6663 7.00065C13.6663 5.97112 13.433 4.9961 13.0162 4.12559C12.876 3.83259 12.491 3.78552 12.2613 4.01522L7.27582 9.00065C6.75512 9.52135 5.9109 9.52135 5.3902 9.00065L3.52827 7.13872C3.26792 6.87837 3.26792 6.45626 3.52827 6.19591C3.78862 5.93556 4.21073 5.93556 4.47108 6.19591L6.33301 8.05784L11.5675 2.82708C11.7571 2.63755 11.7648 2.33059 11.5696 2.14676C10.3763 1.02278 8.7684 0.333984 6.99967 0.333984C3.31778 0.333984 0.333008 3.31875 0.333008 7.00065C0.333008 10.6825 3.31778 13.6673 6.99967 13.6673Z" fill="#007B5C" />
                              </svg>
                            </div>
                            <span className="texTopBot">Jan 9, 2022</span>
                        ...
                        <table class="table table-borderless">
                          <tbody>
                            <tr>
                              ...
                              <td><h6 class="textItemOrder1">Ozark Trail Sand Island Beach Wagon Cart, Outdoor and Camping, Blue, Adult</h6>SKU: 760256796 </td>
                    ...
                    <div class="col-12">
                      ...
                      <div class="bottomRight">
                        ...
                        <div class="bottomRightEqu1">
                          ...
                          <div class="textFloatTotal"><h6>Toltal:</h6></div><br />
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="divBodyBottom">
                  <div class="textItemBottom">
                    <span><svg class="checkIconBot" width="12" height="15" viewBox="0 0 12 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <span>CUSTOMER DETAILS</span></span>
                  ...
                  <div class="textItemBottom">
                    <span><svg class="checkIconBot" width="14" height="11" viewBox="0 0 14 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      {" "}
                      <span>CONTACT INFORMATION</span></span>
                    ...
                    <div class="col-md-6 col-xs-12">
                      <div class="textItem2">
                        <button type="button" class="btn btn-success " onClick={() => this.setModal(true)}>
                          <div class="textItemOrder" ><i class="bi bi-plus-lg iconAdd"></i>Add</div>
                        </button>
                      </div>
                    </div>
                  </div>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class="textItemOrder">
                            <div class="iconDelete"><i class="bi bi-pencil"></i></div>
                            <div class="iconEdit"><i class="bi bi-trash3"></i></div>
                          </td>
                        </tr>
                        <tr>
                          <td class="textItemOrder">
